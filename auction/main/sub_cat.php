            ...
            <div class="col-md-6 grid-margin stretch-card" >
              <div class="card">
                <div class="card-body" style="border-right: 3px solid blue;border-radius: 20px;">
                  <h4 class="card-title" style="color:blue"> Sub Category</h4>
                  
                  <form class="forms-sample" action="sub_cat.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" name="subname">
                    </div>
...
<?php
  if(isset($_POST['save']))
  {
    ...
    $subcategoryname=$_POST['subname'];
     ...
     if(mysqli_query($con,"INSERT INTO subcategory VALUES('','".$categoryname."','".$subcategoryname."')"))
    {
      echo "
      <script>
      alert('New Record Added');
      window.location.href='sub_cat.php';
      </script>
      ";
    }
    else
