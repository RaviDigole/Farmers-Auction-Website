                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        {
                          $cname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM category WHERE id='".$row[1]."'"));

                        echo'
                        <tr>
                          <td style="font-weight: bold;">'.$sr_no.'</td>
                          <td style="font-weight: bold;">'.$cname[1].'</td>
                          <td style="font-weight: bold;">'.$row[2].'</td>
                          <td >
                          <a href="update_sub.php?id='.$row[0].'">
                            <label style="font-weight: bold;" class="badge badge-primary">Edit</label>
                          </td>
                          <td>
                           <a href="delete_subcategory.php?id='.$row[0].'">
