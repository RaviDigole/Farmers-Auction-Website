...
session_start();
    ...
    $unit=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM unit WHERE id='".$_GET['id']."'"));
?>
<html lang="en">
            ...
            <div class="col-md-6 grid-margin stretch-card" >
              <div class="card">
                <div class="card-body" style="border-right: 3px solid blue;border-radius: 20px;">
                  <h4 class="card-title" style="color:blue">Update Unit</h4>
                  
                  <form class="forms-sample" action="update_unit.php?id=<?php echo $unit[0]?>" method="POST" enctype="multipart/form-data">
                 
                    <div class="form-group">
                      <label for="exampleInputUsername1"> Unit Name</label>
                      <input type="text" value="<?php echo $unit[1]?>" class="form-control" id="exampleInputUsername1" name="uname">
                      <input type="hidden" value="<?php echo $unit[0]?>" class="form-control" id="exampleInputUsername1" name="id">
                    </div>
...
<?php
  if(isset($_POST['save']))
  {
    ...
    $id=$_POST['id'];
     ...
     if(mysqli_query($con,"UPDATE unit SET unit_name='".$uname."' WHERE id='".$id."'"))
    {
      echo "
      <script>
