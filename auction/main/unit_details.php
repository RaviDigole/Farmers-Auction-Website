                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                        $sr_no=1;
                        $res=mysqli_query($con,"SELECT * FROM unit");
                        while($row=mysqli_fetch_row($res))
                        {
                           $uname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM unit WHERE id='".$row[1]."'"));
                        echo'
                        <tr>
