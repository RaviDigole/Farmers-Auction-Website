...
session_start();
    ...
    $sdata=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM category WHERE id='".$_GET['id']."'"));
?>
<html lang="en">
<head>
  <!-- Required meta tags -->
            ...
            <div class="col-md-6 grid-margin stretch-card" >
              <div class="card">
                <div class="card-body" style="border-right: 3px solid #000;border-radius: 20px;">
                  <h4 class="card-title" style="color:blue">Update Category</h4>
                  
                  <form class="forms-sample" action="update_cat.php?id=<?php echo $sdata[0]?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">


                      <label for="exampleInputUsername1">Category Name</label>
                      <input type="text" value="<?php echo $sdata[1]?>" class="form-control" id="exampleInputUsername1" name="catname">
...
<?php
  if(isset($_POST['save']))
  {
    ...
    $id=$_POST['id'];
     ...
     if(mysqli_query($con,"UPDATE category SET ncame='".$categoryname."' WHERE id='".$id."'"))
    {
      echo "
      <script>
