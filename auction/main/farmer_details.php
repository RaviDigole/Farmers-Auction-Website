   ...
   ?>
    ...
    <div class="container-fluid page-body-wrapper">
     ...
     ?>
      ...
      <div class="main-panel" style="margin-top: -30px; margin-left: -25px;">        
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <thead>
                        <tr style=" background-image: linear-gradient(#7300e6, #5900b3,#6600cc, #4d0099);color: #fff;">
                          <th>Sr.NO</th>
                          <th>Photo</th>
                      ...
                      <tbody>
                        <?php
                        $sr_no=1;
                        $res=mysqli_query($con,"SELECT * FROM farmer2_data");
                        ...
                        <tr>
                          ...
                          <td style="font-weight: bold;">'.$row[5].'</td>
                          <td style="font-weight: bold;">'.$row[6].'</td>
                          <td>
                          <a href="update_farmer.php?id='.$row[0].'">
                            <label style="font-weight: bold;" class="badge badge-primary">Edit</label>
                          </td>
                          <td>
                          <a href="delete_farmer.php?id='.$row[0].'">
