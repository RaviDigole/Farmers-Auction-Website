            ...
            <div class="col-md-6 grid-margin stretch-card" >
              <div class="card">
                <div class="card-body" style="border-right: 3px solid #000;border-radius: 20px;">
                  <h4 class="card-title" style="color:blue">Category</h4>
                  
                  <form class="forms-sample" action="category.php" method="POST">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Category Name</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="catname">
                    </div>
...
<?php
  if(isset($_POST['save']))
  {
    $categoryname=$_POST['catname'];
     ...
     if(mysqli_query($con,"INSERT INTO category VALUES('','".$categoryname."')"))
    {
      echo "
      <script>
