...
<body>
    ...
    <form action="login2.php" method="POST">
        ...
        <input type="text" autocomplete="false" name="uname" placeholder="Email or Phone" id="username">
       ...
       <a href="reg.php">Create An Account</a>
        ...
        <button name="save">Log In</button>
    </form>
</body>
</html>
<?php
if(isset($_POST['save']))
{
    ...
    $res=mysqli_query($con,"SELECT * FROM farmer2_data WHERE uname='".$uname."' && pass='".$pass
        ."'");
