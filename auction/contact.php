...
<html lang="en-us"><head>
  ...
  <!--Favicon-->
  <link rel="shortcut icon" href="logo2.jfif" type="image/x-icon">
  <link rel="icon" href="logo2.jfif" type="image/x-icon">
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-white">
      <a class="navbar-brand order-1" href="index.html">
        <img class="img-fluid" width="100px" src="logo2.jfif"
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="abt_auction.html">About Us</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <div class="a" style=""><center><img src="farmer_photos/last.jfif"></center></div>
        <div class="content mb-5" style="margin-left: 250px;">
          <h2 id="we-would-love-to-hear-from-you">Know Us</h2>
          <p style="font-size: 20px;">kisankalyanyojana@gmail.com<br>telephone No:123123</p>
...
<footer class="footer">
  ...
  <div class="container">
      ...
      <div class="col-md-2 text-center mb-4">
          <a href="index.html"><img class="img-fluid" width="100px" src="logo2.jfif" alt="Reader | Hugo Personal Blog Template"></a>
      </div>
