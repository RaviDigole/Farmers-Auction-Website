                      ...
                      <article class="card mb-4">
                        ...
                        <div class="row card-body">
                          ...
                          <div class="col-md-8">
                            ...
                            <ul class="card-meta list-inline">
                              ...
                              <li class="list-inline-item">
                                <ul class="card-meta-tag list-inline">
                                  ...
                                  <li class="list-inline-item" ><a href="#" style="background-color:pink;color:#fff">Auction Price Rs - '.$row[12].'<input type="hidden" id="aprice'.$row[0].'" value="'.$row[12].'">
                            ...
                            <p>
                                <button class="btn btn-xs btn-success" onclick="get_product_intrest('.$row[0].','.$row[5].')">Purchase Now</button>
                            </p>
